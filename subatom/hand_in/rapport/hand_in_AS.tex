...
Detta gäller dock bara om strålmålet som används är isotoprenat, alltså bara innehåller $^{76}_{34}\mathrm{Se}$. (Är det inte isotoprenat behöver man dessutom titta på vilka andra reaktikoner som kan ske i produktionen, utöver de i \figref{fig:x-sect}.) Naturligt förekommande selen innehåller dock bara ca 9,4\,\% $^{76}_{34}\mathrm{Se}$ \cite{wiki_selenium}. Detta gör att strålmålet behöver ha en täthet på
\begin{equation}
