...
%\caption{A circular orbit around the Earth}
%\label{fig:orbit}
%\end{figure}
...
\end{equation}
We see that we are almost there. We just need to use one more
...
\todo[inline]{There is a part ii and iii to this problem as well.}
...
since there is no indeces for the affine connection to work on. Next
we get
\begin{equation}
\Box\phi=\pd_\mu(g^{\mu\nu}\pd_\nu)\phi
...
\end{bmatrix}.
\end{equation}
We can now write down the Laplacian as
\begin{equation}
