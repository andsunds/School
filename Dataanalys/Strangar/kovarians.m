...
% Vissa tider ska tas med en nypa salt. Ibland sv�rt att v�lja tiderna i
% h1,h2,h3,h4. De med 1-2 tidssteg �r kanske tveksamma. 
% h best�mmer antalet tidssteg f�r mod 1,2,3 osv
...
for j=1:k
    Y(:,j) = [ones(h(j),1);NaN(N-h(j),1)]; % Placera ettor de som ska va kvar och NaN p� de som ej ska va med.
end
