...
plot [-10:1000] [-0.1:2] "28ms_dw_WAVEFORM.tsv" using 1:2 with lines lt -1 lc 3 title s.'Waveform, $\tau=\unit[28]{ms}$',\
                         ...
                         "28ms_dw_PEAKS.tsv" using 1:2 pt 6  ps 2 lc 7 title s.'Peaks, $\tau=\unit[28]{ms}$',\
                         "50ms_dw_PEAKS.tsv" using 1:2 pt 12 ps 2 lc 7 title s.'Peaks, $\tau=\unit[50]{ms}$',\
                         A28*exp(-R28*x)+bkg28 dt 1 lw 4 lc 0 title s.'Fit, $\tau=\unit[28]{ms}$',\
                         A50*exp(-R50*x)+bkg50 dt 4 lw 4 lc 0 title s.'Fit, $\tau=\unit[50]{ms}$'
