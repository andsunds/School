...
\vspace{-4mm}\begin{equation}
\int\rd^dk\,f(k)
=\overbrace{\text{``Area of sphere in $d$ dimensions''}}^{=:\Sd}
...
\Omega =-\frac{g_sTL^d\Sd}{d\,\lambda^d \pi^\D{2}}
\Gamma\qty(\nD{2}+1)g_{\D{2}+1}(z).
\end{equation}
...
=\frac{g_sT\V\Sd}{d\,\lambda^d \pi^\D{2}}
\Gamma\qty(\nD{2}+1)\qty(\pdv{\mu}g_{\D{2}+1}(z))_{T,\V}.
\end{equation}
...
\begin{equation}
n_\ee=\frac{N_\ee}{\V}
=\frac{g_s\V\Sd}{d\,\lambda^d \pi^\D{2}}
\Gamma\qty(\nD{2}+1)g_{\D{2}}(z).
\end{equation}
