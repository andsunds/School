...
\footnotetext{This was a very neat way to derive $\kappa_S$. One could
  ...
  unfortunately the analogous approach yields an expression which
  contains $(\pdv*{\mu}{V})_T$, which is not readily evaluated.} 
...
\footnotetext{Lord and Savior in our times of need and despair!}
...
factor $-2/d$. 
\footnotetext{For the energy, we do not need to worry about the
...
Anyway the sketch of the heat capacity is in \figref{fig:Cv}.
...
%  LocalWords:  compressibility compressibilities isothermal
