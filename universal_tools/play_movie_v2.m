function [  ] = play_movie_v2(T,Q,m,dim,framesize, playbackspeed )
...
switch dim
    case 1 %improve for 1D
        ...
        for i=1:(length(T)-1)
            ...
            axis([T(i)-framesize, T(i)+framesize,...
                R_cm(i,1,1)-framesize, R_cm(i,1,1)+framesize]);
        end%end for
    ...
    case 2
        ...
        for i=1:(length(T)-1)
            ...
            axis([R_cm(i,1,1)-framesize, R_cm(i,1,1)+framesize,...
                  R_cm(i,1,2)-framesize, R_cm(i,1,2)+framesize]);
        end%end for
    ...
    case 3
        ...
        for i=1:(length(T)-1)
            ...
            axis([R_cm(i,1,1)-framesize, R_cm(i,1,1)+framesize,...
                  R_cm(i,1,2)-framesize, R_cm(i,1,2)+framesize,...
                  R_cm(i,1,3)-framesize, R_cm(i,1,3)+framesize]);
        end%end for
end%end switch
