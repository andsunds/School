...
Resterande del av detta kapitel bygger på information från boken \emph{The Cell} av G. M. \todo{ok så här?} Cooper~\cite{Cooper_TheCell2000} om inget annat anges.
...
\includegraphics[width=\textwidth]{bilder/Illu_cell_structure.jpg}
\caption{Anatomi för en eukaryot cell. Cytoplasman innehåller många olika organeller av varierande storlek. Publik bild.}
...
\section{Cellers metabola tillståndeds påverkan på partikelrörelsen}
...
fungerande cell. En cell som drabbats av cancer \todo{källa. Det var också Gou?}kommer att ha en
förhöjd metabolism\cite{Gou_etal2014} för att öka på celldelningstakten och kanske är det i samband med detta som även diffusionen i cytoplasman ökar. En möjlig förklaring till fenomenet utpekas i dessa studier som icke-termiska fluktuationer orsakade av motorproteinernas sammanlagda aktivitet.
