...
\subsubsection{Urvalsregel för dipolövergångar} 
\label{sec:regler}
\todo{Hunds regler?}
...
elektronkonfigurationer tillsammans med motsvarnde termer.
\todo{Vad är dessa bra för?}
...
finns en term per konfiguration och $S$-värde är att den elektron som
inte exciterats är i ett s-tillstånd, vilket motsvarar $l=0$ så det
...
konstant. Detta eftersom den, förutom våglängdsnoggrannheten, även
styr intensiteten på det detekterade ljuset.
...
Vidare visas vilka våglänger och energier för de detekterade topparna
i Hg-spektrumet i \tabref{tab:Hg_toppar}. 
