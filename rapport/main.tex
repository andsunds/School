...
\todo{Anpassa till att vi redan har kända energinivåer.}
...
från NIST~\cite{NIST_spectrum}, dels vilka toppar dom detekterats. Man
kan notera att det som kan se ut som en topp i bilden faktiskt är
flera vilket syns bland de utmarkerade topparna. 
...
rekonstruktion visaas i \tabref{tab:Hg_nivaer}.
För en detaljerad lista över vilka våglängder och energier som
detekterades för topparna i kvicksilverspektrumet hänvisas läsaren
till \tabref{tab:Hg_toppar} i Bilaga~\ref{sec:kompl}. 
...
\todo{Noteras det i diskussionen?} 
...
sådana sammanhang försöka undersöka vad för bergränsningar som finns. 

\subsubsection{Upplösning i spektrometern}
\label{sec:diskussion_upplosning}
Spektrometern, Spex~270M, har en elingt tillverkaren \cite{Spex270M}
våglängdsupplösning på $\Delta\lambda=\unit[0,1]{nm}$. Men den faktiska upplösningen beror i
högsta grad på vilka inställningar man använder; i synnerhet beror
upplösningen på spaltbredden för det insläppta ljuset. 

I mätningarna på kvicksilverspektrat, där våglängds upplösning är av
...
För att relatera detta till upplösning i energinivåerna kan vara mer
intressant att studera den relativa upplösningen,
...
En annan möjligorsak till fel i kvicksilverspektrat är
våglängdskalibreringen. Den gjordes bara mot en punkt
(Na-dubbletten). Det kan hända att spektrometern är byggd så bra att
det bara behövs. Men i princip hade det varit skönt om man kunde
...
kommer vi nu gå igenom några spakter, men i Bilaga~\ref{sec:korr}
finns vidare material på detta område. 

Jämför man spektrat det uppmätta och det teoretiska spektrat
...
känsligheten beräknades en korrektionsfaktor som varierade mellan
1--100. 
Detta föranleder bland annat att mätningar
utanför detta område bör betraktas med försiktighet -- en topp där kan
bara ha varit brus som gick över tröskeln och blev förstorat av
korrektionsfaktorn. 
...
$6^3\mathrm{P}_0$ som är det lägsta exciterade tillståndet. 
...
korrektionsfaktorn är tämligen osäker om den stämmer. För vidare
dislussion om detta, se Bilaga~\ref{sec:korr}. 
...
beräknades i avsnitt~\ref{sec:diskussion_upplosning} verkar
stämma. 
...
energier begränsas av våglängds upplösningen\footnotemark{}
\[
...
våglängderna oftast inns många möjliga kandiadater. Detta gör det
...
som enligt \cite{NIST_levels} bara sklijer sig med 1\,meV som är
...
dessa två nivåer, varför de båda kan betraktas samma i den här
rapporten. 
