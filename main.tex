...
In conclusion, we only considered quantitative results due to the due to unreliability of results of diffusivity. Experiments were done for  No results were seen in dry paper due to its molecular structure. 
