...
\footnotetext{I have attached a copy of the relevant derivation in Appendix~\ref{sec:comm}}
...
\figref{fig:cylinder}. The boundary conditions on the wave function is
\begin{equation}
\begin{cases}
...
\footnotetext{We should really have the same absolute value in the case
