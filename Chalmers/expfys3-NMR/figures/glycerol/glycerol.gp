...
set key width -7
set output "glyc.tex"
plot [0:50] [30:60] "glyc-paper.tsv" using 1:(1e3*$2):(1e3*($2-$3)):(1e3*($2+$4)) with yerrorbars lt 1 pt 4 ps 1.2 lc 2 title s.'Gylcerol paper',\
                    "glyc-paper-ex.tsv" using 1:(1e3*$2):(1e3*($2-$3)):(1e3*($2+$4)) with yerrorbars lt 1 pt 8 ps 1.2 lc 3 title s.'Ex. glycerol paper',\
