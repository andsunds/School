...
easily solved numerically \todo{Check if right}(\figref{fig:LA1}). 
...
\end{aligned}
\end{equation}
$Z(\phi)$ \todo{Check if right}(\figref{fig:LA2}B) is called the infinitesimal impulse phase
...
indeed robust \todo{Check if right}(\figref{fig:Pfeuty5}). 
...
\begin{figure}[h!]
\centering
\subfigure[][]{\includegraphics[width=.4\textwidth]{Fig3A.pdf}}
\subfigure[][]{\includegraphics[width=.4\textwidth]{Fig3B.pdf}}
...
\subfigure[][$\nabla\phi(\phi)$]{\includegraphics[width=1\textwidth]{Fig4A.pdf}}
\end{minipage}~\begin{minipage}{.32\linewidth}
\subfigure[][$Z(\phi)$]{\includegraphics[width=1\textwidth]{Fig4B.pdf}}
\subfigure[][$V(\phi)$]{\includegraphics[width=1\textwidth]{Fig4C.pdf}}
\end{minipage}
\caption{
