...
%Här har kovariansen delats med respektive standardavvikelse för att korrelationsfuntionen ska ge ett värde mellan $-1$ och $1$, där $1$ motsvarar perfekt korrelation och $-1$ perfekt antikorrelation, vilket följer av Cauchy-Schwarzs\cite{Engelberg_noise2007} olikhet 
%\begin{equation}
...
Vad som menas med ''tillräckligt snälla'' processer framgår om man tittar på inledningen av resonemanget som leder fram till beviset av \eqref{eq:W-K-theorem}. Den börjar med att betrakta högerledet i \eqref{eq:PSD}~\cite{Miller_probability2012}
\begin{equation}
\begin{aligned}
